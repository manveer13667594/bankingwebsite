// // ============ SIDEBAR ============
// // HTML used when running over file:// to avoid fetch restrictions
// const sidebarHtml = `
// <aside class="sidebar">
//     <div class="sidebar-header">
//         <div class="logo">
//             <svg class="logo-icon" viewBox="0 0 40 40">
//                 <polygon points="20,5 35,15 35,25 20,35 5,25 5,15" fill="white"/>
//             </svg>
//             <span>BankName</span>
//         </div>
//     </div>
...
//             <span>Dashboard</span>
//         </a>
//         <a href="accounts.html" class="menu-item" data-page="accounts">
//             <span class="menu-icon">👤</span>
//             <span>Accounts</span>
//         </a>
...
//         </a>
//         <a href="transfer.html" class="menu-item" data-page="transfer">
//             <span class="menu-icon">→</span>
//             <span>Transfer Money</span>
//         </a>
//         <a href="cards.html" class="menu-item" data-page="cards">
//             <span class="menu-icon">💳</span>
//             <span>Cards</span>
//         </a>
//         <a href="loans.html" class="menu-item" data-page="loans">
//             <span class="menu-icon">📋</span>
//             <span>Loans</span>
//         </a>
...
//     const page = document.body.classList.contains('dashboard-page')
//         ? 'dashboard'
//         : document.querySelector('main h1')?.textContent?.toLowerCase();
...
//         // local file access – just insert static HTML
